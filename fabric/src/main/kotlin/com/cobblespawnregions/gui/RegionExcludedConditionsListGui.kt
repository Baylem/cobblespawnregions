...
object RegionExcludedConditionsListGui {
    ...
    private fun conditionEntry(condition: String): ItemStack {
        val item = CustomGui.createPlayerHeadButton(
            "exc_$condition",
            Component.literal(condition).withStyle(ChatFormatting.RED),
            listOf(
                Component.literal(""),
                Component.literal("§c§lEXCLUDED").withStyle(ChatFormatting.BOLD),
                Component.literal("§7Spawns matching this string"),
                Component.literal("§7will be blocked."),
                Component.literal(""),
                Component.literal("§eClick §7to remove")
            ),
